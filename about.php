    ...
    <section>
      <!-- creating definition lists, terms, and descriptions -->
        ...
        <dl>
            ...
            <dd>About Page, CSS, Created EOI database, and created process_eoi</dd>

            <dt><strong>Member 2: </strong>Nicholas Kan</dt>
            <dd>Application Page, CSS, created manage.php</dd>

            <dt><strong>Member 3: </strong>Shafiullah Mohamed Hakkim</dt>
            <dd>Home Page, CSS, Php Modularisation, settings.php, and Enhancements page</dd>

            <dt><strong>Member 4: </strong>Toan Nguyen Nhu Duc</dt>
            <dd>Job Description Page, CSS, Created Jobs database</dd>
        </dl>
    </section>
